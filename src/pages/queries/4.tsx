...
const Query4: NextPage = () => {
  const { data: restaurants } = api.restaurants.get.useQuery();

  const [restaurant, setRestaurant] = useState("");

  const request = api.queries.fourth.useMutation();
  ...
  return (
    <>
      ...
      <MainHeader>Запит 4</MainHeader>

      <div>
        <Typography variant="h4" className="font-normal" color="blue-gray">
          Знайти назви тих ресторанів, що мають ті й тільки ті категорії, що й
          ресторан з назвою X.
        </Typography>
        <form
